...
class WebsitecardView extends StatelessWidget {
  const WebsitecardView({super.key});
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                top: 60,
                left: 20,
                child: Customappbarcard(text: "Website"),
              ),
              Positioned(
                top: 200,
                child: TextfieldcardContainer(label: "Web URL", hintText: "www.qrcode.com", maxLines: 1, GenerateQr_Onpressed: (){}, image: AppAssets.WesiteIcone1, )
              ),
            ],
          ),
        ),
