...
import 'package:qr_code/Features/Generate_Qr/Presentation/Views/Widgets/EventCard_Container.dart';
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                top: 60,
                left: 20,
                child: Customappbarcard(text: "Event"),
              ),
              Positioned(
                top: 120,
                child: EventcardContainer(GenerateQr_Onpressed: (){})
              ),
            ],
          ),
        ),
