...
import 'package:qr_code/Features/Generate_Qr/Presentation/Views/Widgets/WiFiCardContainer.dart';


class WificardView extends StatelessWidget {
  const WificardView({super.key});
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                top: 60,
                left: 20,
                child: Customappbarcard(text: "Wi-Fi"),
              ),
              Positioned(
                top: 200,
                child: Wificardcontainer(GenerateQr_Onpressed: (){},))
