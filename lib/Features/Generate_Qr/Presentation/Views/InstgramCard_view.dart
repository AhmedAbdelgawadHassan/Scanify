...
class InstgramcardView extends StatelessWidget {
  const InstgramcardView({super.key});
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                top: 60,
                left: 20,
                child: Customappbarcard(text: "Instgram"),
              ),
              Positioned(
                top: 200,
                child: TextfieldcardContainer(label: "Username", hintText: "Enter Instagram Username", maxLines: 1, GenerateQr_Onpressed: (){}, image: AppAssets.InstagramIcon1, )
              ),
            ],
          ),
        ),
