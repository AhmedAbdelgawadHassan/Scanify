...
import 'package:scanify/features/onboarding/widgets/LetsStartButton.dart';
...
class OnboardingView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double width =
        MediaQuery.of(context).size.width; // get the Full width of the screen
    return Scaffold(
